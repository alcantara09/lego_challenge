...
@pytest.fixture
def analyse_users_use_case(brick_repository_with_data: BricksRepository) -> AnalyseUsers:
    return AnalyseUsers(brick_repository_with_data)
...
def test_retrieve_other_users_with_parts(analyse_users_use_case: AnalyseUsers, brick_repository_with_data: BricksRepository, missing_parts: Inventory):
    basic_parts = brick_repository_with_data.get_all_parts()
